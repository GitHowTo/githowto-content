...
> **Nerd fact #2:** there's always at least one branch in a repository, even if you don't create any branches yourself. It is usually called the "main" (or "main") branch.
