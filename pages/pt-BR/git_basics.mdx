...
**Fato nerd nº 2:** sempre há pelo menos uma ramificação em um repositório, mesmo que você não crie nenhuma ramificação. Normalmente, ele é chamado de branch "principal" (ou "main").
